...
export function Footer16({
  ...
  return (
    <footer className="relative w-full overflow-hidden bg-black font-sans text-zinc-100 antialiased ">
      <motion.div
      ...
      >
        <div className="relative z-10 border-t border-white/10 bg-black/1 px-4 pt-9 pb-7 shadow-[0_-24px_80px_rgba(9,10,14,0.34)] backdrop-blur-sm sm:px-12 sm:pt-11 sm:pb-8 lg:pt-[46px]">
