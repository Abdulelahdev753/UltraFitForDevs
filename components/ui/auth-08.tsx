...
interface Auth8Props {
  mode?: AuthMode;
}

export default function Auth8({ mode = "signup" }: Auth8Props) {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col lg:flex-row bg-[#050505] font-sans text-white antialiased selection:bg-green-500/30 selection:text-white">
      {/* Left Image Panel */}
      <div className="relative flex w-full flex-col justify-between overflow-hidden min-h-[40vh] lg:min-h-screen lg:w-1/2">
        {/* Background Image */}
        <img
          src={`${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/auth-bg.png`}
          alt="Green abstract background"
          className="absolute inset-0 h-full w-full object-cover"
        />

        {/* Readability scrim — darkens the bright lime area behind the text */}
        ...
        <div className="relative z-10 p-10 pb-20">
          <h1 className="mb-6 text-5xl font-semibold leading-[1.1] tracking-tight text-white xl:text-6xl [text-shadow:0_2px_18px_rgba(0,0,0,0.6)]">
            Speed up your work<br />
            with our Web App
          </h1>
          <p className="max-w-lg text-lg text-white [text-shadow:0_1px_12px_rgba(0,0,0,0.55)]">
        ...
        >
          ...
          <form className="flex flex-col gap-5">
            ...
            <motion.div variants={itemVariants} className="mt-4">
              <button
                type="submit"
                className="w-full rounded-lg bg-[#16A34A] py-3.5 text-sm font-semibold text-white transition-all hover:bg-[#15803D] active:scale-[0.98]"
              >
          ...
          >
            {isSignup ? (
              ...
              <>
                ...
                <Link href="/register" className="font-semibold text-[#16A34A] hover:underline">
                  Sign up
                </Link>
              </>
            )}
